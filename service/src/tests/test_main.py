...
@pytest.mark.parametrize(
    ...
    [
        # Valid input
        ({
            "sex": "male", "units": "si", "age": 30, "weight": 70.0, "height": 1.75,
            "weight_loss_rate": 0.5, "duration": 12
        }, 200, "valid input"),
        # Invalid age (too low)
        ({
            "sex": "male", "units": "si", "age": 19, "weight": 70.0, "height": 1.75,
            "weight_loss_rate": 0.5, "duration": 12
        }, 422, "invalid age"),
        # Invalid weight (zero)
        ({
            "sex": "male", "units": "si", "age": 30, "weight": 0.0, "height": 1.75,
            "weight_loss_rate": 0.5, "duration": 12
        }, 422, "invalid weight"),
        ...
        ({
            "sex": "male", "units": "si", "age": 30, "weight": 70.0, "height": 1.75,
            "weight_loss_rate": -0.5, "duration": 12
        }, 422, "invalid weight_loss_rate"),
        # Missing required field (sex)
        ({
            "units": "si", "age": 30, "weight": 70.0, "height": 1.75,
            "weight_loss_rate": 0.5, "duration": 12
        }, 422, "missing field sex"),
        # Invalid units
        ({
            "sex": "male", "units": "metric", "age": 30, "weight": 70.0, "height": 1.75,
            "weight_loss_rate": 0.5, "duration": 12
        }, 422, "invalid units"),
    ],
)
